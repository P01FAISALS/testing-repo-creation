...
// in {{ cookiecutter.project_name|lower|replace(' ', '_') }}_android/test/{{ cookiecutter.project_name|lower|replace(' ', '_') }}_android_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MethodChannelRelaxed extends _i1.Mock implements _i4.MethodChannel {
  MethodChannelRelaxed() {
    _i1.throwOnMissingStub(this);
  }
