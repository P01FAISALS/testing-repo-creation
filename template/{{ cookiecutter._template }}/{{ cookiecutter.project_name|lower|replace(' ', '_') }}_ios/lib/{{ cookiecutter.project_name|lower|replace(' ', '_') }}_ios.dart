...
class {{ cookiecutter.project_name|replace(' ', '') }}Ios extends {{ cookiecutter.project_name|replace(' ', '') }}Platform {
  static MethodChannel _channel = const MethodChannel('{{ cookiecutter.project_name|lower|replace(' ', '_') }}');

  static void registerWith() {
    {{ cookiecutter.project_name|replace(' ', '') }}Platform.instance = {{ cookiecutter.project_name|replace(' ', '') }}Ios();
  }

  // TODO add iOS-specific invocations of the {{ cookiecutter.project_name|replace(' ', '') }}Platform here
