...
import 'package:{{ cookiecutter.project_name|lower|replace(' ', '_') }}_ios/{{ cookiecutter.project_name|lower|replace(' ', '_') }}_ios.dart';
...
import '{{ cookiecutter.project_name|lower|replace(' ', '_') }}_ios_test.mocks.dart';
...
void main() {
  ...
  late {{ cookiecutter.project_name|replace(' ', '') }}Ios {{ cookiecutter.project_name|lower|replace(' ', '') }};
  late MockMethodChannel mockChannel;

  setUp(() {
    mockChannel = MockMethodChannel();
    {{ cookiecutter.project_name|replace(' ', '') }}Platform.instance = {{ cookiecutter.project_name|lower|replace(' ', '') }} = {{ cookiecutter.project_name|replace(' ', '') }}Ios();
